...
type GetOK struct {
	...
	/*
	  In: Body
	*/
	Payload []*models.Pokemon `json:"body,omitempty"`
}
...
func (o *GetOK) WithPayload(payload []*models.Pokemon) *GetOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get o k response
func (o *GetOK) SetPayload(payload []*models.Pokemon) {
	o.Payload = payload
}
...
func (o *GetOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
	...
	if payload == nil {
		// return empty array
		payload = make([]*models.Pokemon, 0, 50)
	}
